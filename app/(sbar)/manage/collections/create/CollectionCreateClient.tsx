    ...
    return (
        <div className="layout-container" style={{ padding: '40px 0' }}>
            <div style={{ marginBottom: '24px' }}>
                <Link href="/manage/collections" style={{ color: '#64748b', textDecoration: 'none', fontWeight: 700 }}>
                    ← Back to Collections
                </Link>
            </div>

            <form action={createCollection} style={{ background: 'white', border: '1px solid #e2e8f0', borderRadius: '12px', overflow: 'hidden' }}>
                <input type="hidden" name="creation_mode" value={creationMode} />

                <div style={{ padding: '24px', borderBottom: '1px solid #e2e8f0' }}>
                    <h1 style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--color-primary-light)', marginBottom: '8px' }}>Create Collection</h1>
                    <p style={{ color: '#64748b' }}>Build a custom collection, or define criteria and let the system add matching properties.</p>
                </div>
                ...
                <div style={{ padding: '24px', display: 'grid', gap: '24px' }}>
                    ...
                    {creationMode === 'manual' ? (
                        <div style={{ display: 'grid', gap: '14px' }}>
                            ...
                            <div style={{ maxHeight: '430px', overflowY: 'auto', border: '1px solid #e2e8f0', borderRadius: '10px' }}>
                ...
                <div style={{ padding: '18px 24px', borderTop: '1px solid #e2e8f0', display: 'flex', justifyContent: 'flex-end', gap: '12px' }}>
                    <Link href="/manage/collections" style={{ padding: '10px 16px', borderRadius: '8px', border: '1px solid #cbd5e1', background: 'white', color: '#475569', fontWeight: 700, textDecoration: 'none' }}>
                        Cancel
                    </Link>
