...
const locationHierarchy: ProvinceNode[] = [
    ...
    },
    {
        name: 'Koshi Province',
        districts: [
            { name: 'Bhojpur', cities: ['Bhojpur Municipality', 'Shadananda Municipality', 'Hatuwagadhi Rural Municipality', 'Ramprasad Rai Rural Municipality', 'Aamchowk Rural Municipality', 'Tyamke Maiyum Rural Municipality', 'Salpasilichho Rural Municipality', 'Pauwadungma Rural Municipality', 'Arun Rural Municipality'] },
            { name: 'Dhankuta', cities: ['Dhankuta Municipality', 'Pakhribas Municipality', 'Mahalaxmi Municipality', 'Chhathar Jorpati Rural Municipality', 'Sangurigadhi Rural Municipality', 'Sahidbhumi Rural Municipality', 'Chaubise Rural Municipality'] },
            { name: 'Ilam', cities: ['Ilam Municipality', 'Deumai Municipality', 'Mai Municipality', 'Suryodaya Municipality', 'Mai Jogmai Rural Municipality', 'Sandakpur Rural Municipality', 'Mangsebung Rural Municipality', 'Chulachuli Rural Municipality', 'Rong Rural Municipality', 'Fakfokthum Rural Municipality', 'Miklajung Rural Municipality'] },
            { name: 'Jhapa', cities: ['Birtamod Municipality', 'Damak Municipality', 'Mechinagar Municipality', 'Bhadrapur Municipality', 'Arjundhara Municipality', 'Kankai Municipality', 'Gauradaha Municipality', 'Shivasatakshi Municipality', 'Buddhashanti Rural Municipality', 'Kachankawal Rural Municipality', 'Barhadashi Rural Municipality', 'Jhapa Rural Municipality', 'Gauriganj Rural Municipality', 'Haldibari Rural Municipality'] },
            { name: 'Khotang', cities: ['Diktel Rupakot Majhuwagadhi Municipality', 'Halesi Tuwachung Municipality', 'Kepilasgadhi Rural Municipality', 'Aiselukharka Rural Municipality', 'Rawa Besi Rural Municipality', 'Sakela Rural Municipality', 'Barahapokhari Rural Municipality', 'Diprung Rural Municipality', 'Jantedhunga Rural Municipality', 'Khotehang Rural Municipality'] },
            { name: 'Morang', cities: ['Biratnagar Metropolitan City', 'Sundarharaicha Municipality', 'Belbari Municipality', 'Pathari-Shanishchare Municipality', 'Rangeli Municipality', 'Urlabari Municipality', 'Letang Municipality', 'Budhiganga Rural Municipality', 'Kanepokhari Rural Municipality', 'Miklajung Rural Municipality', 'Kerabari Rural Municipality', 'Jahada Rural Municipality', 'Dhanpalthan Rural Municipality', 'Gramthan Rural Municipality', 'Katahari Rural Municipality', 'Sunwarshi Municipality'] },
            { name: 'Okhaldhunga', cities: ['Siddhicharan Municipality', 'Khiji Demba Rural Municipality', 'Chishankhugadhi Rural Municipality', 'Molung Rural Municipality', 'Manebhanjyang Rural Municipality', 'Sunkoshi Rural Municipality', 'Likhu Rural Municipality', 'Champadevi Rural Municipality'] },
            ...
            { name: 'Sankhuwasabha', cities: ['Khandbari Municipality', 'Chainpur Municipality', 'Madi Municipality', 'Bhotkhola Rural Municipality', 'Makalu Rural Municipality', 'Silichong Rural Municipality', 'Chichila Rural Municipality', 'Sabhapokhari Rural Municipality', 'Tumlingtar'] },
            { name: 'Solukhumbu', cities: ['Solududhkunda Municipality', 'Khumbu Pasanglhamu Rural Municipality', 'Mahakulung Rural Municipality', 'Nechasalyan Rural Municipality', 'Thulung Dudhkoshi Rural Municipality', 'Mapya Dudhkoshi Rural Municipality', 'Likhu Pike Rural Municipality'] },
            { name: 'Sunsari', cities: ['Dharan Sub-Metropolitan City', 'Itahari Sub-Metropolitan City', 'Inaruwa Municipality', 'Duhabi Municipality', 'Ramdhuni Municipality', 'Barahachhetra Municipality', 'Koshi Rural Municipality', 'Bhokraha Narsingh Rural Municipality', 'Gadhi Rural Municipality', 'Dewanganj Rural Municipality', 'Harinagara Rural Municipality', 'Barju Rural Municipality'] },
            { name: 'Taplejung', cities: ['Phungling Municipality', 'Pathibhara Yangwarak Rural Municipality', 'Sirijangha Rural Municipality', 'Mikwakhola Rural Municipality', 'Phaktanglung Rural Municipality', 'Aathrai Tribeni Rural Municipality', 'Sidingba Rural Municipality', 'Maiwakhola Rural Municipality'] },
            { name: 'Terhathum', cities: ['Myanglung Municipality', 'Laligurans Municipality', 'Aathrai Rural Municipality', 'Chhathar Rural Municipality', 'Phedap Rural Municipality', 'Menchayam Rural Municipality'] },
            { name: 'Udayapur', cities: ['Triyuga Municipality', 'Chaudandigadhi Municipality', 'Katari Municipality', 'Belaka Municipality', 'Udayapurgadhi Rural Municipality', 'Rautamai Rural Municipality', 'Tapli Rural Municipality', 'Limchungbung Rural Municipality'] },
        ],
    },
    {
