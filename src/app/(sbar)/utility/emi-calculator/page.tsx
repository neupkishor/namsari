        ...
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div className="card" style={{ padding: '40px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '48px' }}>
                    ...
                    {/* Results & Chart */}
                    <div style={{ background: 'transparent', padding: '32px', borderRadius: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '1px solid #e2e8f0' }}>
