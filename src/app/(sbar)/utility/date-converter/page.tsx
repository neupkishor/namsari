    ...
    return (
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div className="card" style={{ padding: '40px' }}>
                ...
                <div style={{ display: 'flex', background: 'transparent', padding: '4px', borderRadius: '12px', marginBottom: '32px' }}>
                    <button
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        ...
                        <input
                            ...
                            style={{
                                ...
                                background: mode === 'BS_TO_AD' ? 'transparent' : 'white'
                            }}
                        />
                    </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        ...
                        <input
                            ...
                            style={{
                                ...
                                background: mode === 'AD_TO_BS' ? 'transparent' : 'white'
                            }}
                        />
                    </div>
                </div>

                <div style={{ marginTop: '32px', padding: '16px', borderRadius: '12px', background: 'transparent', color: '#854d0e', fontSize: '0.9rem', border: '1px solid rgba(212, 175, 55, 0.2)' }}>
