                ...
                <nav style={{ display: 'flex', gap: '8px', fontWeight: '500', fontSize: '0.9rem', alignItems: 'center' }}>
                    ...
                    {!user ? (
                        ...
                        <Link
                            href="/manage"
                            className="header-link"
                            style={{ padding: '8px 16px', borderRadius: '8px', color: 'var(--color-primary)', fontWeight: '700', textDecoration: 'none', transition: 'all 0.2s', display: 'flex', alignItems: 'center', gap: '8px' }}
                        >
