...
type Property = {
  ...
  listedBy?: { name?: string; username?: string; contact_number?: string; phone?: string; whatsapp?: string; profile_picture?: string; type?: string };
  author_name?: string;
  author_phone?: string;
  created_on?: string;
  views?: number;
...
const styles = StyleSheet.create({
  ...
  sellerCard: { backgroundColor: colors.white, borderWidth: 1, borderColor: colors.line, borderRadius: 20, padding: 14, flexDirection: 'row', alignItems: 'center' }, sellerAvatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.primarySoft, alignItems: 'center', justifyContent: 'center' }, sellerInitial: { color: colors.primary, fontSize: 18, lineHeight: 24, fontWeight: '900' }, sellerCopy: { flex: 1, marginLeft: 12 }, sellerName: { color: colors.ink, fontSize: 14, lineHeight: 20, fontWeight: '800' }, sellerType: { color: colors.muted, fontSize: 10, lineHeight: 15, marginTop: 2 }, sellerArrow: { color: colors.primary, fontSize: 27, lineHeight: 30 },
